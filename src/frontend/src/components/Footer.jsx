    ...
    <footer className="bg-gray-900 border-t border-gray-800 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/markets" className="text-gray-400 hover:text-white text-sm">Markets</a></li>
              <li><a href="/leaderboard" className="text-gray-400 hover:text-white text-sm">Leaderboard</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © 2024 PRIMAPE Markets. All rights reserved. Built on Solana.
          </p>
        </div>
      </div>
    </footer>
